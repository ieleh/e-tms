...
namespace e_tms.Web.Controllers
{
    public class CompaniesController : Controller
    {
        ...
        public ActionResult GetData(int page = 1, int rows = 10, string sort = "Id", string order = "asc", string filterRules = "")
        {
            ...
            var datarows = companies.Select(n => new { Id = n.Id, Name = n.Name, Address = n.Address, City = n.City, Province = n.Province, RegisterDate = n.RegisterDate, Logo = n.Logo }).ToList();
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Address,City,Province,RegisterDate,Logo")] Company company)
        {
        ...
        [HttpPost]
        //[ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Address,City,Province,RegisterDate,Logo")] Company company)
        {
            if (ModelState.IsValid)
            {
